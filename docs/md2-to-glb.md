...
| `--units` | raw units | Source units: `mm\|cm\|m\|km\|in\|ft\|yd`. |
...
- MD2 skins (PCX paths) are informational; reattach game textures via [texture-convert](texture-convert.md).
- Quake 3 models use [md3-to-glb](md3-to-glb.md) instead — refused with that pointer.
